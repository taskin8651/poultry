...
<div class="mx-auto w-full">
    ...
    <div class="mb-8 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="badge-premium badge-info">
                        {{ $abouts->count() }} Entries
                    </span>

                </div>

                <p class="mt-1 text-sm text-slate-500">
                    Manage the "About Us" content shown on your website
                </p>
        ...
        <a href="{{ route('admin.abouts.create') }}" class="btn-premium btn-premium-primary">
    ...
    @if($abouts->count())
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            ...
            @foreach($abouts as $about)
                ...
                @php
                    $image = $about->getFirstMediaUrl('about_image');
                @endphp
                ...
                <div class="item-card card-premium overflow-hidden rounded-[26px]">
                    ...
                    <div class="border-t border-slate-100 bg-white p-5">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <a href="{{ route('admin.abouts.edit', $about->id) }}" class="action-btn btn-premium btn-premium-amber">
                            ...
                            <form
                                method="POST"
                                action="{{ route('admin.abouts.destroy', $about->id) }}"
    ...
    @else
        ...
        <div class="card-premium rounded-[28px] px-6 py-20 text-center">
            ...
            <p class="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                Create your first "About Us" entry to tell visitors about your business.
            </p>

            <a href="{{ route('admin.abouts.create') }}" class="btn-premium btn-premium-primary mt-6">
                <i class="bi bi-plus-lg"></i>
                Create First About
            </a>
