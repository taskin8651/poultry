...
<div class="mx-auto max-w-4xl">
    ...
    <div class="mb-7 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="{{ route('admin.abouts.index') }}" class="btn-premium btn-premium-outline">
        ...
        >
            ...
            <div class="border-b border-slate-100 p-6 sm:p-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Update the title and subtitle of this section.
                    </p>
                ...
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            Update the details shown in the About section.
                        </p>
                    </div>
            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        @php
                            $currentImage = $about->getFirstMediaUrl('about_image');
                        @endphp
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="input-premium">
                            ...
                            <option value="1" {{ $about->status ? 'selected' : '' }}>
                                Active
                            </option>

                            <option value="0" {{ !$about->status ? 'selected' : '' }}>
                                Inactive
                            </option>
                        ...
                        <div class="mt-4 rounded-2xl bg-slate-50 p-5">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex h-10 w-10 items-center justify-center rounded-full {{ $about->status ? 'bg-emerald-100 text-emerald-600' : 'bg-red-100 text-red-600' }}">
                                    <i class="bi {{ $about->status ? 'bi-check-circle-fill' : 'bi-x-circle-fill' }}"></i>
                                </div>
